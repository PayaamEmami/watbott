...
Technically, WatBott is a chatbot, but I prefer to use the title "AI assistant" to hopefully inspire a more forward thinking approach to what new technologies and functionalities that can be brought to Twitch chatbots.
...
Having the ability to understand input and respond with proper dialogue could and should provide solutions for numerous useful features that chatbots could and should have. 
